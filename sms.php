<!--SMS.PHP is designed for sending Message to the user via WAY2SMS(generally used when forgotten password is to be retrieved)-->
...
class WAY2SMSClient
{
    ...
    Variable Listing
    * $curl is for URL
    * $way2smsHost is name of host
    * $refurl is reference URL
    * $timeout is for sending message after a particular time
    **/
    var $curl;
    var $timeout = 30;
    var $jstoken;
    ...
    /**
    * @login function is used for sending message to client
    * @param1 is the username registered on WAY2SMS.COM
    * @param2 is the password for that account
    */
   function login($username, $password)
    {
        ...
        /**
        * @preg_match(pattern,String) searches String for a particular pattern and return true if exists
        * @param1 is required pattern
        * @param2 is provided String
        * @return boolean
        */

        if (preg_match('#Location: (.*)#', $a, $r))
            $this->way2smsHost = trim($r[1]);               //@trim(String) removes White Spaces From String
    ...
    /**
     * @param $phone is Employee's Contact Number
     * @param $msg is the Message to be delivered
     * @return array
     */
